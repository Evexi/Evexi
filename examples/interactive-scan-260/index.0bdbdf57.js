...
$35968c1d1652764a$var$t42 = $35968c1d1652764a$var$a, Object.defineProperty($35968c1d1652764a$var$t42, "__esModule", {
    value: !0
}), $35968c1d1652764a$var$t42.b2bSerialPrint = $35968c1d1652764a$var$t42.EnvironmentType = $35968c1d1652764a$var$t42.Actions = void 0, ($35968c1d1652764a$var$n = $35968c1d1652764a$var$t42.Actions || ($35968c1d1652764a$var$t42.Actions = {})).INFO = "info", $35968c1d1652764a$var$n.LOG = "log", $35968c1d1652764a$var$n.STORAGE_GET = "storage.get", $35968c1d1652764a$var$n.STORAGE_PUT = "storage.put", $35968c1d1652764a$var$n.STORAGE_DELETE = "storage.delete", $35968c1d1652764a$var$n.STORAGE_LIST = "storage.list", $35968c1d1652764a$var$n.STORAGE_CLEAR = "storage.clear", $35968c1d1652764a$var$n.STORAGE_DOWNLOAD = "storage.download", $35968c1d1652764a$var$n.STORAGE_EXISTS = "storage.exists", $35968c1d1652764a$var$n.INTERACT_CREATE = "interact.create", $35968c1d1652764a$var$n.INTERACT_START = "interact.start", $35968c1d1652764a$var$n.INTERACT_DESTROY = "interact.destroy", $35968c1d1652764a$var$n.INTERACT_MESSAGE = "interact.message", $35968c1d1652764a$var$n.INTERACT_KICK = "interact.kick", $35968c1d1652764a$var$n.KIOSK_BARCODE = "kiosk.barcode", $35968c1d1652764a$var$n.KIOSK_PRINTER = "kiosk.printer", $35968c1d1652764a$var$n.PROXY = "proxy", $35968c1d1652764a$var$n.ENV_VAR = "envVar", ($35968c1d1652764a$var$e17 = $35968c1d1652764a$var$t42.EnvironmentType || ($35968c1d1652764a$var$t42.EnvironmentType = {})).SSSP2 = "SSSP2", $35968c1d1652764a$var$e17.HTML = "HTML", $35968c1d1652764a$var$e17.TIZEN = "TIZEN", $35968c1d1652764a$var$e17.KIOSK = "KIOSK", $35968c1d1652764a$var$i = $35968c1d1652764a$var$t42.b2bSerialPrint || ($35968c1d1652764a$var$t42.b2bSerialPrint = {}), ($35968c1d1652764a$var$o = $35968c1d1652764a$var$i.PrinterPort || ($35968c1d1652764a$var$i.PrinterPort = {})).PRINTERPORT0 = "PRINTERPORT0", $35968c1d1652764a$var$o.PRINTERPORT1 = "PRINTERPORT1", $35968c1d1652764a$var$o.PRINTERPORT2 = "PRINTERPORT2", ($35968c1d1652764a$var$r = $35968c1d1652764a$var$i.PrinterParity || ($35968c1d1652764a$var$i.PrinterParity = {})).NONE = "NONE", $35968c1d1652764a$var$r.ODD = "ODD", $35968c1d1652764a$var$r.EVEN = "EVEN", ($35968c1d1652764a$var$s1 = $35968c1d1652764a$var$i.PrinterDataBits || ($35968c1d1652764a$var$i.PrinterDataBits = {})).BITS5 = "BITS5", $35968c1d1652764a$var$s1.BITS6 = "BITS6", $35968c1d1652764a$var$s1.BITS7 = "BITS7", $35968c1d1652764a$var$s1.BITS8 = "BITS8";
var $35968c1d1652764a$var$u = function(t1, n1) {
    return $35968c1d1652764a$var$u = Object.setPrototypeOf || ({
        __proto__: []
    }) instanceof Array && function(t2, n2) {
        t2.__proto__ = n2;
    } || function(t3, n3) {
        for(var e1 in n3)Object.prototype.hasOwnProperty.call(n3, e1) && (t3[e1] = n3[e1]);
    }, $35968c1d1652764a$var$u(t1, n1);
};
var $35968c1d1652764a$var$f = function() {
    return $35968c1d1652764a$var$f = Object.assign || function(t4) {
        ...
        return t4;
    }, $35968c1d1652764a$var$f.apply(this, arguments);
};
function $35968c1d1652764a$var$l(t5, n5, e3, i2) {
...
function $35968c1d1652764a$var$h(t10, n8) {
...
var $35968c1d1652764a$var$v = {};
Object.defineProperty($35968c1d1652764a$var$v, "__esModule", {
    value: !0
}), $35968c1d1652764a$var$v.queryString = $35968c1d1652764a$var$p = $35968c1d1652764a$var$v.keys = $35968c1d1652764a$var$d = $35968c1d1652764a$var$v.promiseTimeout = void 0;
var $35968c1d1652764a$var$d = $35968c1d1652764a$var$v.promiseTimeout = function d(t11, n9) {
...
var $35968c1d1652764a$var$p = $35968c1d1652764a$var$v.keys = function p(t12) {
    return Object.keys(t12);
};
$35968c1d1652764a$var$v.queryString = function(t13) {
    var n10 = Object.keys(t13).map(function(n11) {
        return n11 + "=" + t13[n11];
    }).join("&");
    return n10 ? "?".concat(n10) : "";
};
function $35968c1d1652764a$var$T(t14) {
    try {
        window.parent.postMessage(JSON.stringify($35968c1d1652764a$var$f({}, t14)), "*");
    } catch (n) {
        throw new Error("wrapperNoListener error");
    }
}
function $35968c1d1652764a$var$E(t15, n12, e7) {
    return $35968c1d1652764a$var$l(this, void 0, void 0, function() {
        var i5;
        return $35968c1d1652764a$var$h(this, function(o4) {
            switch(o4.label){
                case 0:
                    return o4.trys.push([
                        0,
                        ...
                        4,
                        $35968c1d1652764a$var$d(e7 || 5e3, new Promise(function(e8) {
                            var i6, _$o, r5;
                            i6 = function i6(t16) {
                                e8(t16.response);
                            }, _$o = $35968c1d1652764a$var$f({
                                action: t15.action
                            }, n12), r5 = function(t17) {
                                var _$n = JSON.parse(t17.data);
                                if (_$n) try {
                                    $35968c1d1652764a$var$p(_$o).forEach(function(t18) {
                                        if (_$o[t18] !== _$n[t18]) throw new Error("");
                                    }), window.removeEventListener("message", r5, !0), i6(_$n);
                                } catch (t) {}
                            }, window.addEventListener("message", r5, !0), window.parent.postMessage(JSON.stringify($35968c1d1652764a$var$f({}, t15)), "*");
                        }))
                    ];
                case 1:
                    return [
...
var $35968c1d1652764a$var$O = new function() {
    this.all = {
        get: function get(t19) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_GET,
                name: t19
            }, {
                name: t19
            });
        ...
        put: function put(t20, n13) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_PUT,
                name: t20,
                data: n13
            }, {
                name: t20
        ...
        del: function del(t21) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_DELETE,
                name: t21
            }, {
                name: t21
            });
        ...
        list: function list() {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_LIST
            });
        },
        clear: function clear() {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_CLEAR
            });
        },
        download: function download(t22, n14) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_DOWNLOAD,
                url: t22,
                name: n14
            }, {
                name: n14
        ...
        exists: function exists(t23) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.STORAGE_EXISTS,
                name: t23
            }, {
                name: t23
            });
...
}, $35968c1d1652764a$var$S = {}, $35968c1d1652764a$var$y = {};
!function(t24) {
    var n15, e9;
...
var $35968c1d1652764a$var$I = {};
Object.defineProperty($35968c1d1652764a$var$I, "__esModule", {
    value: !0
});
var $35968c1d1652764a$var$g = {};
!function(t25) {
    var n16;
...
}($35968c1d1652764a$var$g);
var $35968c1d1652764a$var$A = {};
!function(t26) {
...
}($35968c1d1652764a$var$A), function(t28) {
    var n17, e10 = $35968c1d1652764a$var$c1 && $35968c1d1652764a$var$c1.__createBinding || (Object.create ? function(t29, n18, e11, i8) {
        i8 === undefined && (i8 = e11);
    ...
    }), i7 = $35968c1d1652764a$var$c1 && $35968c1d1652764a$var$c1.__setModuleDefault || (Object.create ? function(t31, n20) {
        ...
        t32["default"] = n21;
    }), o5 = $35968c1d1652764a$var$c1 && $35968c1d1652764a$var$c1.__importStar || function(t33) {
    ...
    Object.defineProperty(t28, "__esModule", {
        value: !0
    }), t28.WebsocketAction = t28.HealthCheck = t28.Interact = t28.Settings = t28.Sp = void 0, t28.Sp = o5($35968c1d1652764a$var$y), t28.Settings = o5($35968c1d1652764a$var$I), t28.Interact = o5($35968c1d1652764a$var$g), t28.HealthCheck = o5($35968c1d1652764a$var$A), (n17 = t28.WebsocketAction || (t28.WebsocketAction = {})).SP = "sp", n17.SETTINGS = "settings", n17.CLEAR_AND_RESTART = "clearrestart", n17.REBOOT = "reboot", n17.LOGS = "logs", n17.PING = "ping", n17.INTERACT = "interact", n17.INTERACT_START = "interact:start", n17.TRANSITION = "transition", n17.HC_HEALTH = "health", n17.HC_SETTINGS = "info:settings", n17.HC_INFO = "info", n17.HC_STORAGE = "info:storage";
}($35968c1d1652764a$var$S);
var $35968c1d1652764a$var$_, $35968c1d1652764a$var$R, $35968c1d1652764a$var$w = new function() {
    var t34 = this;
    this.all = {
        create: function create(t35, n23, e13, i10) {
            return $35968c1d1652764a$var$E($35968c1d1652764a$var$f($35968c1d1652764a$var$f($35968c1d1652764a$var$f({
                action: $35968c1d1652764a$var$a.Actions.INTERACT_CREATE,
                maxRuntime: t35
            }, n23 && {
                clientUrl: n23
            }), e13 && {
        ...
        start: function start() {
            return $35968c1d1652764a$var$T({
                action: $35968c1d1652764a$var$a.Actions.INTERACT_START
            });
        },
        destroy: function destroy() {
            t34.events = {}, $35968c1d1652764a$var$T({
                action: $35968c1d1652764a$var$a.Actions.INTERACT_DESTROY
            });
        },
        message: function message(t36, n24) {
            return $35968c1d1652764a$var$T($35968c1d1652764a$var$f({
                action: $35968c1d1652764a$var$a.Actions.INTERACT_MESSAGE,
                data: t36
            }, n24 && {
                client: n24
            }));
        ...
        kick: function kick(t37) {
            return $35968c1d1652764a$var$T({
                action: $35968c1d1652764a$var$a.Actions.INTERACT_KICK,
                client: t37
            });
        },
        ...
        e14.action === $35968c1d1652764a$var$a.Actions.INTERACT_MESSAGE && (e14.event === $35968c1d1652764a$var$S.Interact.InteractiveEvent.MESSAGE && t34.events.onMessage && e14.data && t34.events.onMessage(e14.data, e14.client), e14.event === $35968c1d1652764a$var$S.Interact.InteractiveEvent.CONNECT && t34.events.onConnect && t34.events.onConnect(e14.client), e14.event === $35968c1d1652764a$var$S.Interact.InteractiveEvent.DISCONNECT && t34.events.onDisconnect && t34.events.onDisconnect(e14.client), e14.event === $35968c1d1652764a$var$S.Interact.InteractiveEvent.KICK && t34.events.onKick && t34.events.onKick(e14.client));
    });
}, $35968c1d1652764a$var$b = new function() {
    this.all = {
        barcode: function barcode() {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.KIOSK_BARCODE
            }, undefined, 3e4);
        },
        printer: function printer(t38, n30) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.KIOSK_PRINTER,
                data: t38,
                printerSettings: n30
            });
        }
    };
}, $35968c1d1652764a$var$m = new function() {
    this.all = {
        request: function request(t39, n31) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.PROXY,
                proxy: {
                    url: t39,
                    request: n31
                }
    ...
    this.all = {
        env: function env(t40) {
            return $35968c1d1652764a$var$E({
                action: $35968c1d1652764a$var$a.Actions.ENV_VAR,
                name: t40
            }, {
                name: t40
            });
...
}, $35968c1d1652764a$var$N = function N() {
    this.fs = $35968c1d1652764a$var$O.all, this.interactive = $35968c1d1652764a$var$w.all, this.tizen = $35968c1d1652764a$var$b.all, this.proxy = $35968c1d1652764a$var$m.all.request, this.env = $35968c1d1652764a$var$P.all.env, this.log = function(t41) {
        return $35968c1d1652764a$var$T({
            action: $35968c1d1652764a$var$a.Actions.LOG,
            data: t41
        });
    }, this.info = function() {
        return $35968c1d1652764a$var$E({
            action: $35968c1d1652764a$var$a.Actions.INFO
        });
    };
}, $35968c1d1652764a$var$C = {
...
}($35968c1d1652764a$var$_ || ($35968c1d1652764a$var$_ = {})), function(t) {
    t.InitializationError = "Initialization Failed";
}($35968c1d1652764a$var$R || ($35968c1d1652764a$var$R = {}));
var $35968c1d1652764a$var$k = function(t43) {
    var n36 = function n36(n37) {
        var e16 = t43.call(this, n37) || this;
        return e16.name = $35968c1d1652764a$var$R.InitializationError, e16;
    };
    return function(t, n38) {
        ...
        $35968c1d1652764a$var$u(t, n38), t.prototype = null === n38 ? Object.create(n38) : (e.prototype = n38.prototype, new e);
    }(n36, t43), n36;
}(Error), $35968c1d1652764a$var$x = function() {
    var t44 = function t44(t45, n39) {
        ...
        if (this.sessionId = t45, this.environmentKey = n39, this.socket = null, this.pingInterval = null, this.events = {
            ...
            onOpen: null,
            onClose: null
        }, !t45) throw new $35968c1d1652764a$var$k("sessionId not provided");
        this.socket = new WebSocket("".concat((e = n39, $35968c1d1652764a$var$_[e || "Prod"]), "/").concat(t45)), this.socket.onmessage = function(t) {
    ...
    return t46.prototype.fs = function() {
        ...
        return this.Evexi.fs = {
            get: function get(n41) {
                return $35968c1d1652764a$var$l(t, void 0, void 0, function() {
                    return $35968c1d1652764a$var$h(this, function(t) {
                        return [
                            2,
                            {
                                name: n41,
        ...
        var n43 = this, e18 = function e18(e, i14) {
            return $35968c1d1652764a$var$l(n43, void 0, void 0, function() {
                var n44, o8, r6;
                return $35968c1d1652764a$var$h(this, function(s) {
                    switch(s.label){
                        case 0:
        ...
        return this.Evexi.proxy = function(n46, o9) {
            return $35968c1d1652764a$var$l(this, void 0, void 0, function() {
                return $35968c1d1652764a$var$h(this, function(r) {
...
}(), $35968c1d1652764a$export$429f1c4820dd15e8 = function D() {
    this.api = new $35968c1d1652764a$var$N, this.helper = $35968c1d1652764a$var$C, this.Scan = $35968c1d1652764a$var$x, this.env = this.api.env, this.fs = this.api.fs, this.info = this.api.info, this.interactive = this.api.interactive, this.log = this.api.log, this.proxy = this.api.proxy, this.tizen = this.api.tizen;
